...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "isaruhullah035@mail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "01927-604035",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I’m available for Remote job. If you need a modern, clean and
                high-performance website or web application Developer, feel free to reach out — I’d
